# genpark-cross-codebase-api-migration-impact-mapper-skill
...
**genpark-cross-codebase-api-migration-impact-mapper-skill** is a deterministic, zero-dependency Python skill engineered for autonomous software engineering agents, codebase refactoring, and AST intelligence pipelines.

> **Executive Capability**: Multi-repo cross-codebase API migration impact mapper & codemod (Greptile)
...
result = client.map_api_migration_impact()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-cross-codebase-api-migration-impact-mapper-skill": {
      "command": "python",
      "args": ["/path/to/genpark-cross-codebase-api-migration-impact-mapper-skill/mcp_server.py"]
    }
  }
}
```
